...
function EquipmentChecklist() {
  ...
  // ===================== PRINT FUNCTION =====================
  const handlePrint = () => {
    // Get supervisor name from localStorage or submissionData
    const userName = localStorage.getItem("userName") ||
                     JSON.parse(localStorage.getItem("user") || "{}")?.name ||
                     "Unknown";
    ...
    // Build table rows
    const tableRows = equipment.map((item, index) => {
      ...
      <body>
        <div class="print-container">
          ...
          <div class="supervisor">
            <span class="supervisor-label">Supervisor:</span> ${submittedByName}
          </div>
      ...
      >
        <div
          style={{
            width: '40px',
            height: '40px',
            border: '3px solid #e5ede9',
            borderTop: '3px solid #006341',
            borderRadius: '50%',
    ...
    >
      ...
      {!submitted && (
        ...
        >
          ...
          >
            <span>
              📊 Progress: {checkedCount} / {totalCount} items checked
            </span>
      ...
      {submitted && submissionData && (
        ...
        >
          <p>
            ✅ This checklist has been confirmed and submitted to OT Department.
          </p>
